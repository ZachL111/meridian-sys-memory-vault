"""Regression checks for the meridian-sys-memory-vault casebook."""
...
from casebook.harness import assert_expected, meridian_sys_memory_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_sys_memory_vault_summary(), assert_expected())
